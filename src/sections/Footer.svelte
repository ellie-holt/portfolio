...
>
      ...
      >
        ...
        <div class="flex justify-center items-center gap-4">
          ...
          >
            ...
            >
            <span
              class="3xs:text-left text-center group-hover:decoration-transparent underline transition-all duration-300 ease-in"
  ...
  <div
    class="right-0 bottom-0 left-0 absolute flex justify-between items-center mx-2.5 xs:mx-5 md:mx-6 lg:mx-6 xl:mx-6 h-10"
  >
    <p class="pl-2 4xs:pl-4 3xs:pl-6 font-mono text-sm 3xs:text-base">
      &copy; 2025 Ellie Holt.
    </p>
    <p class="pr-2 4xs:pr-4 3xs:pr-6 font-mono text-sm 3xs:text-base">
      Open source <a
